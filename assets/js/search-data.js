...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/physics-lab/";
          ...
          title: "Teaching",
          description: "Course materials and academic resources.",
          section: "Navigation",
          handler: () => {
            window.location.href = "/physics-lab/teaching/";
          },
        },{id: "nav-news",
          title: "News",
          description: "",
        ...
        handler: () => {
          ...
          section: "Books",handler: () => {
            ...
            },},{id: "news-발표-baryons-2025-lim-hyunji-amp-amp-ji-sujeong-11-11-exhic-d-2025-smith-krista-11-16-kshep-2025-fall-meeting-lim-sanghoon",
          title: '📢 [발표] Baryons 2025 — Lim HyunJi &amp;amp;amp; Ji SuJeong (11/11) · ExHIC-d...',
          description: "",
          section: "News",},{id: "news-수상-choi-sanghyeon-우수상-수상-lim-hyunji-우수발표상-수상",
          title: '🏆 [수상] Choi, SangHyeon 우수상 수상, Lim, HyunJi 우수발표상 수상',
          description: "",
          section: "News",},{id: "news-발표-fkppn-학회-발표-lim-sanghoon-12-17-ryu-jaehyeok-12-16-oh-jongho-amp-amp-choi-changhwan-12-15",
          title: '📢 [발표] FKPPN 학회 발표 — Lim SangHoon (12/17), Ryu JaeHyeok (12/16), Oh...',
          description: "",
          ...
          section: "Projects",handler: () => {
              window.location.href = "/physics-lab/projects/2_project/";
            },},{id: "projects-project-3-with-very-long-name",
          title: 'project 3 with very long name',
          description: "a project that redirects to another website",
          section: "Projects",handler: () => {
              window.location.href = "/physics-lab/projects/3_project/";
            },},{id: "projects-project-4",
          title: 'project 4',
          description: "another without an image",
          section: "Projects",handler: () => {
              window.location.href = "/physics-lab/projects/4_project/";
            },},{id: "projects-project-5",
          title: 'project 5',
          description: "a project with a background image",
          section: "Projects",handler: () => {
              window.location.href = "/physics-lab/projects/5_project/";
            },},{id: "projects-project-6",
          title: 'project 6',
          description: "a project with no image",
          section: "Projects",handler: () => {
              window.location.href = "/physics-lab/projects/6_project/";
            },},{id: "projects-project-7",
          title: 'project 7',
          description: "with background image",
          section: "Projects",handler: () => {
              window.location.href = "/physics-lab/projects/7_project/";
            },},{id: "projects-project-8",
          title: 'project 8',
          description: "an other project with a background image and giscus comments",
          section: "Projects",handler: () => {
              window.location.href = "/physics-lab/projects/8_project/";
        ...
        section: 'Socials',
        handler: () => {
          window.open("/physics-lab/assets/pdf/example_pdf.pdf", "_blank");
        },
      },{
        id: 'social-email',
        title: 'email',
        ...
        section: 'Socials',
        handler: () => {
          window.open("/physics-lab/feed.xml", "_blank");
        },
      },{
        id: 'social-scholar',
