...
ninja.data = [{
    ...
    handler: () => {
      window.location.href = "/physics-lab/";
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/physics-lab/blog/";
          },
        },{id: "nav-publications",
          title: "publications",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/physics-lab/repositories/";
          },
        },{id: "nav-cv",
          title: "CV",
          ...
          section: "Navigation",
          handler: () => {
            window.location.href = "/physics-lab/cv/";
          },
        },{id: "nav-teaching",
          title: "teaching",
          ...
          handler: () => {
            window.location.href = "/physics-lab/people/";
              ...
              section: "Dropdown",
              handler: () => {
                window.location.href = "/physics-lab/books/";
              },
            },{id: "dropdown-blog",
              title: "blog",
              description: "",
        ...
        handler: () => {
          ...
          section: "News",handler: () => {
              window.location.href = "/physics-lab/news/announcement_2/";
